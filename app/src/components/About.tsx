  ...
  return (
    <section className="py-12 px-6">
      <div className="max-w-3xl mx-auto grid grid-cols-3 gap-3">
        ...
        <div className="col-span-2 bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg p-4">
        ...
        <div className="col-span-1 bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg p-4">
          <div className="flex items-center gap-1.5 mb-3 text-cyan-400">
            <SparkleIcon />
